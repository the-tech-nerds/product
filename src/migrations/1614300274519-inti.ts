...
export class inti1614300274519 implements MigrationInterface {
    name = 'inti1614300274519'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `brands` (`created_by` int NOT NULL, `updated_by` int NULL, `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` datetime(6) NULL, `id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `supplier_id` int NOT NULL, UNIQUE INDEX `REL_99a66874581b656ee6efed8c0c` (`supplier_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
